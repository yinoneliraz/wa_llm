...
def upgrade() -> None:
    ...
    op.add_column('group', sa.Column('community_keys', sa.ARRAY(sa.String()), nullable=True))
    op.create_index('idx_group_community_keys', 'group', ['community_keys'], unique=False, postgresql_using='gin')
    op.alter_column('kbtopic', 'start_time',
...
def downgrade() -> None:
    ...
    op.alter_column('kbtopic', 'start_time',
               ...
               existing_nullable=False)
    op.drop_index('idx_group_community_keys', table_name='group', postgresql_using='gin')
